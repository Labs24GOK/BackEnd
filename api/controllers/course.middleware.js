...
const validateCourseID = catchAsync(async (req, res, next) => {
  ...
  if (!course) {
    next(new AppError('Course with that ID does not exist', 406));
    return;
  }
  req.course = course;
...
const validateCourseBody = catchAsync(async (req, res, next) => {
